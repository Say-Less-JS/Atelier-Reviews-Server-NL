...
module.exports = {
  ...
  addReview: function(params,photos, callback) {
    const query = `INSERT INTO reviews (product_id, rating, summary, body, recommend, reviewer_name, reviewer_email, date)
    ...
    if(photos.length !== 0) {
      photos.forEach(photo => {
        const photoQuery = 'INSERT INTO reviewsPhotos(review_id, url) VALUES (nextval(\'reviews_id_seq\'), $1)';
